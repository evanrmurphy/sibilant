        ...
        case "assign":
          return (function() {
            if ((token.length < 4)) {
              ...
              return (macros.assign.apply(undefined, token.slice(1, (token.length - 2))) + "\nreturn " + macros.assign.apply(undefined, token.slice(-2)));
            };
          })();
...
macros.def = (function(fName, argsAndBody) {
  // fName:required argsAndBody:rest
  ...
  return (start + fNameTr + " = " + macros.lambda.apply(undefined, argsAndBody) + ";\n");
});
