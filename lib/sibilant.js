...
var tokenize = sibilant.tokenize = (function(string) {
  ...
  var handleToken = (function(token) {
    ...
    }).call(this) : (function() {return special = false;}).call(this));
...
macros.return = (function(token) {
  ...
  return ((token) && (token).constructor.name === "Array" ? (function() {
    ...
    case "delete":
      ...
      return ((token.length < 3) ? defaultReturn : (deleteMacro.apply(undefined, token.slice(1, -1)) + "\nreturn " + deleteMacro((token.slice(-1))[0])));
    ...
    case "set":
      return ((token.length < 5) ? defaultReturn : (function() {
        var obj = (token)[1],
...
var transformArgs = (function(arglist) {
  ...
  arglist.forEach((function(arg) {
    return (((arg)[0] === "&") ? (function() {return last = arg.slice(1);}).call(this) : (function() {
...
var translate = (function(token, hint) {
  ...
  return (function() {
    if (typeof(token) !== 'undefined') {
      (typeof(token) === "string" ? (function() {return token = token.trim();}).call(this) : undefined);
      return (function() {
        try {
