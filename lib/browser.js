(function() {
  ...
  var tokenize = sibilant.tokenize = (function(string) {
    ...
    var handleToken = (function(token) {
      ...
      (function() {
        ...
        case "{":
          increaseNesting(); return acceptToken("hash");
        
        case "[":
          increaseNesting(); return acceptToken("list");
        
        default:
          return (token.match((new RegExp(("^" + sibilant.tokens.number + "$"), undefined))) ? acceptToken(parseFloat(token)) : acceptToken(token));
        }
      })();
  ...
  return $((function() {
    ...
    var evalWithTryCatch = (function(js) {
      return (function() {
        try {
          ...
          return (function() { console.log(js); throw new Error (e); }).call(this);
        }
      })();
    });
    ;
    sibilant.scriptLoaded = (function() {
      var lisp = null,
          js = null;;
      return (function() { if ((!sibilant.loadNextScript())) { return $("script[type=\"text/lisp\"]:not([src])") // chain
        .each((function() {
          lisp = $(this) // chain
            .text()
            .replace(/(^\s*\/\/\<!\[CDATA\[)|(\/\/\]\]>\s*$)/g, "")
