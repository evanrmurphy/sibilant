(function() {
  ...
  var buildArgsString = (function(args, rest) {
    ...
    args.forEach((function(arg, optionIndex) {
      ...
      return (function() {
        if (((arg)[0] === "optional")) {
          return argsString = (argsString + "if (arguments.length < " + (args.length - optionalCount) + ")" + " // if " + translate((arg)[1]) + " is missing" + indent(("var " + map(args.slice((optionIndex + 1)), (function(arg, argIndex) {
