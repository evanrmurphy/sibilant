...
var createContext = (function() {
  ...
  (function() { for (var key in global) (function() {
...
readline.on("line", (function(cmd) {
  var jsLine = "",
      flushed = true;;
  (function() { try { return (function() { cmdBuffer = (cmdBuffer + cmd);; sibilant.tokenize(cmdBuffer).forEach((function(stmt) {
    return jsLine = (jsLine + sibilant.translate(stmt, "statement"));;
  })); var result = script.runInContext(jsLine, context, "sibilant-repl");; (readline.history)[0] = cmdBuffer;; (function() { if (typeof(result) !== 'undefined') { return flushed = stream.write(("result: " + sys.inspect(result) + "\n"));; } }).call(this); (context)["_"] = result;; return cmdBuffer = "";; }).call(this); } catch (e) { return (function() { return (function() { if (e.message.match("unexpected EOF")) { return (function() { cmdBuffer = (cmdBuffer + " ");; return readline.history.shift(); }).call(this); } else { return (function() { (readline.history)[0] = cmdBuffer;; flushed = stream.write(e.message);
  return cmdBuffer = "";; }).call(this); } }).call(this); }).call(this); } }).call(this);
