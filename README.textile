...
<pre><code>(def example (a &optional b c &optional d e)
...
Lambdas are defined just like functions (with @&rest@ and @&optional@ args, if you so desire), but with the fn keyword.
